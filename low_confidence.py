...
class LowConfidenceAdapter(BestMatch):
    ...
    def process(self, input_statement):
        ...
        #Writing unanswered questions to text file
            path = 'C:/A_stuff/Learning/Machine Learning/ML_Experimental_Learning/ChatterBot/Rxclaim_ChatBot/'
            f = open(path + 'Unanswered_Questions.txt','a')
            f.write('\n')
            f.write(str(input_statement) )
            f.close()
